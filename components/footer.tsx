...
const Footer = () => {
  return (
    <footer className="bg-gray-900">
        ...
        <div className="grid md:grid-cols-3 gap-7">
          <div>
            ...
            <p className="text-gray-400">
              ...
              aut possimus dolorum laudantium, nihil aspernatur!
            </p>
          </div>
          <div className="">
      ...
      <div className="max-w-screen-xl mx-auto px-4 border-t border-gray-500 py-8 text-center text-base text-gray500">
